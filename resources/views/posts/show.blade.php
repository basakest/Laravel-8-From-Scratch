                ...
                <section class="col-span-8 col-start-5 mt-10 space-y-6">
                    <x-panel>
                        <form method="POST" action="#">
                            ...
                            <div>
                                <textarea name="body" class="w-full text-sm focus:ring" rows="5" placeholder="Quick, thing of something to say!"></textarea>
                            </div>

                            <div class="flex justify-end mt-6 pt-6 border-t border-gray-200">
                                <button type="submit" class="bg-blue-500 text-white uppercase font-seibold text-xs py-2 px-10 rounded-2xl hover:bg-blue-600">Post</button>
                            </div>
